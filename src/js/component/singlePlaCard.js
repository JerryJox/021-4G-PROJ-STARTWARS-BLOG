      ...
      <div className="col-md textBox">
        <div className="card single-card-descript">
          ...
          <p>
            ...
            quasi saepe deserunt dolorum alias, officia error voluptatem
            consequuntur tempora natus hic. Molestiae aut tempora, placeat id
            non, eius aspernatur et saepe neque labore recusandae ad itaque
            provident amet dicta, quaerat autem consectetur obcaecati officia
            asperiores? Porro, corporis aliquid corrupti maxime dicta.
          </p>
        </div>
      </div>
      ...
      <div className="featuresBar">
        ...
        <div>
          <p className="card-text">
            Rotation<br></br>period
          </p>
          <p>{store.infoPlaneta?.rotation_period}</p>
        </div>
        <div>
          <p className="card-text">
            Orbital<br></br>Period
          </p>
